...
const content: Record<Kind, { title: string; eyebrow: string; body: { h: string; p: string }[] }> = {
  shipping: {
    ...
    body: [
      ...
      { h: "Time of Shipping & Fees", p: `Standard delivery typically takes 3–7 business days depending on your location; rural or remote pin codes may take a little longer. Shipping is free on all prepaid orders across India — no delivery charge at checkout.` },
