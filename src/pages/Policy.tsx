...
const content: Record<Kind, { title: string; eyebrow: string; body: { h: string; p: string }[] }> = {
  shipping: {
    ...
    body: [
      ...
      { h: "Time of Shipping & Fees", p: `Most orders reach you within 3–4 business days of being placed, processing included. Rural or remote pin codes may take a little longer. Shipping is free on all prepaid orders across India — no delivery charge at checkout.` },
  ...
  terms: {
    ...
    body: [
      ...
      { h: "Pricing & Payments", p: "All prices are listed in INR, inclusive/exclusive of applicable taxes as shown at checkout. We reserve the right to update prices and offers without prior notice. Pay securely online via PayU, or choose Cash on Delivery and pay when your order arrives." },
      { h: "Shipping & Delivery", p: `We aim to deliver orders within 3–4 business days of purchase. Delivery timelines may vary by location, courier partner, and unforeseen circumstances; see our Shipping Policy for details. ${site.brand} isn't liable for delays beyond our control.` },
